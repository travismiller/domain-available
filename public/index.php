...
<?php else: ?>
    <form><input type="text" name="d" placeholder="example.com"><button type="submit">check</button></form>
<?php endif; ?>
  </p>
</body>
